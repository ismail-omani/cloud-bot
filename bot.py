...
async def welcome(message: types.Message):
    ...
    f"Bot doesn't support circles or albums!!! Try not to upload videos\n\n"
    f"Команды:\n/start - запускает бота\n"
    f"/help - показывает этот список\n"
    f"/ls - показывает список всез выших файлов\n"
    f"/dlall - скачивает все ваши файлы\n"
    f"/dl file - скачивает файл\n"
    f"/rm file - удаляет файл из облака\n"
    f"/rn oldname newname - меняет имя файла с oldname на newname\n"
    f"/share file - все будут видеть этот файл используя следующую команду(файл всегда можно удалить из общедоступных)\n"
    f"/lsh - показывает список общедоступных файлов\n"
    f"/dlallh - скачивает все общедоступные файлы(не рекомендовано)\n"
    f"/dlh file - скачивает кокретный общедосиупеый файл\n"
    f"/rmh - удаляет общедосиупный файл\n"
    f"/rnh oldname newname - меняет имя общедоступного файла с oldname на newname\n"
    f"Бот не поддерживает кружки или альбомы!!! Не советую загружать видео\n"
    )
